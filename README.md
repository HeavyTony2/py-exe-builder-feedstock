...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/py-exe-builder-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/py-exe-builder-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add py-exe-builder
# for installing globally
pixi global install py-exe-builder
```
...
It is possible to list all of the versions of `py-exe-builder` available on your platform:
...
```
pixi search py-exe-builder --channel conda-forge
```
